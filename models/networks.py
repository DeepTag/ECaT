...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    elif netG == 'latent_flow_splited_resnet_9blocks':
        net = cyclegan_networks.LatentFlowSplitedResnetGenerator(input_nc, output_nc, ngf, norm_value, use_dropout, n_blocks=9,
                                                no_antialias=no_antialias, no_antialias_up=no_antialias_up, opt=opt)
    elif netG == 'mindcorr_splited_resnet_9blocks':
        net = cyclegan_networks.MindCorrSplitedResnetGenerator(input_nc, output_nc, ngf, norm_value, use_dropout, n_blocks=9,
                                                no_antialias=no_antialias, no_antialias_up=no_antialias_up, opt=opt)
    elif netG == 'selfatt_splited_resnet_9blocks':
        net = cyclegan_networks.ResnetSelfAttGenerator(input_nc, output_nc, ngf, norm_value, use_dropout, n_blocks=9,
                                                no_antialias=no_antialias, no_antialias_up=no_antialias_up, opt=opt)

    elif netG == 'ncn_multiscale_splited_resnet_9blocks':
        net = cyclegan_networks.NCNSplitedResnetMultiScaleGenerator(input_nc, output_nc, ngf, norm_value, use_dropout, n_blocks=9,
                                                      no_antialias=no_antialias, no_antialias_up=no_antialias_up,
                                                      opt=opt)
    elif netG == 'ncn_multiscale_splited_resnet2_9blocks':
        net = cyclegan_networks.NCNSplitedResnetMultiScaleGenerator2(input_nc, output_nc, ngf, norm_value, use_dropout, n_blocks=9,
                                                      no_antialias=no_antialias, no_antialias_up=no_antialias_up,
                                                      opt=opt)
    elif netG == 'stylegan2':
