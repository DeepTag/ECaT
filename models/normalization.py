...
try:
    ...
    print('sync_batchnorm not found')
    pass
try:
    import apex
...
class SPADE(nn.Module):
    ...
    def forward(self, x, segmap, similarity_map=None):
        ...
        # print('before interp segmap.shape')
        # print(segmap.shape)
        segmap = F.interpolate(segmap, size=x.size()[2:], mode='bilinear') # use 'nearest' for seg maps
        # print('after interp segmap.shape')
        # print(segmap.shape)
