...
def load_np_mask_array_from_npz(npz_file):
    ...
    #B = np.zeros((25, y, x))
    #if extra_t > 0:
    #    B = np.concatenate((A,  np.tile(A[-1, ::], (extra_t, 1, 1))), axis=0)
    #else:
    #    B = A
    return [B]
# ----------------------------------------------------------------------------------
...
def load_np_datagroups(model_root, groupids, data_type=DataType.VALIDATION):
    ...
    for groupid in groupids:
        ...
        for np_images, np_masks in zip(load_np_mask_array_from_npz(images_npz_file),
                                         load_np_mask_array_from_npz(masks_npz_file)):
...
if __name__ == '__main__':
    ...
    project_data_config_files ='/home/meng/ailab/data/NYU_Cine_Tagging_pairs/Motion_tracking_20200610/val1/Cardiac_ME_val_config.json'
    data_type = 'validation'
    model_root = '/home/meng/ailab/data/NYU_Cine_Tagging_pairs/Motion_tracking_20200610/val1/'
    ...
    project_data_config_files = '/home/meng/ailab/data/NYU_Cine_Tagging_pairs/Motion_tracking_20200610/val1/Cardiac_ME_train_config.json'
    # data_type = 'train'
    # grouped_cine_tag_npz = add_np_data(project_data_config_files, data_type, model_root)
    # tag = grouped_cine_tag_npz[1]
    # cine = grouped_cine_tag_npz[0]
    #
    # a01 = tag[0, ::]
    # a02 = tag[1, ::]
    #
