...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='Tagging_transfer_to_Untagged_Cine', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/research/cbim/vast/my389/ailab/models/cardiac_ME/baseline_us/VM_0927_mse_paper/', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='scregrefaffinedeform', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
